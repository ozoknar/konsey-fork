...
def main(argv: list[str] | None = None) -> None:
    ...
    m.add_argument("from_agent")
    m.add_argument("type")
    m.add_argument("--to", default=None)
    m.add_argument("--payload", default=None)
    _add_common(m)
    ...
    di.add_argument("agent")
    di.add_argument("rationale")
    _add_common(di)
    di.set_defaults(func=dissent)

    inc = sub.add_parser("incident")
    inc.add_argument("session")
    inc.add_argument("type")
    inc.add_argument("detail")
    _add_common(inc)
